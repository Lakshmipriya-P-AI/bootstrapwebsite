...
<body>
    <div class="container-fluid bg-light text-black text-center mt-3 mb-3">
        <img src=".\img\banner.jpeg" class="img-fluid" style="width:100%; height:200px;" alt="BPR&D">
    </div>
    <div class="row">
        <div class="col mt-3 mb-3" style="background-color:#e6f9ff">
            ...
            <a class="rounded float-end mt-1 mb-1 ms-1 me-1" href="https://www.youtube.com/channel/UCN2fiHd5IFWtNyu-vpAkeEA/videos" target="_blank"> 
                <img src=".\img\policeseva.jpeg" alt="PoliceAurSeva" style="width:150PX; height:30px;">
            </a>
        </div>
    </div>
    ...
    <div class="container-fluid mt-2 mb-2 ms-2 me-2" style="background-color:#ccffff;">
        <div class="row">
                ...
                <div id="demo" class="carousel slide" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src=".\img\img1.jpeg" alt="img1" class="rounded d-block w-100">
                        </div>
                        <div class="carousel-item">
                            <img src=".\img\img2.jpeg" alt="img2" class="rounded d-block w-100">
                        </div>
                        <div class="carousel-item">
                            <img src=".\img\img3.jpeg" alt="img3" class="rounded d-block w-100">
                        </div>
                    </div>
            ...
            <div class="col-sm-3 mt-2">
                <div class="container-fluid rounded bg-light mt-2 mb-2 p-2">
                    <div class="container-fluid bg-light text-black text-center mt-3 mb-3">
                        <img src=".\img\general.jpeg" class="img-fluid rounded" style="width:100%; height:400px;" alt="BPR&D">
                    </div>
        ...
        <footer id="footer">
            <div class="container-fluid text-center rounded bg-light p-2">
                ...
                <div class="credits">
                    Designed by <a href="https://bootstrapmade.com/">Lakshmi priya. P</a>
                </div>
            </div>
        </footer>
    </div>
    ...
    <div class="container-fluid mt-2 mb-2 ms-2 me-2" style="background-color:#ccffff;">
        <div class="row">
            <div class="col-sm-5 mt-2 mb-2">
                <img src=".\img\general.jpeg" class="img rounded float-end" style="width:150px; height:200px;" alt="BPR&D">
            </div>
...
### About us:
![output](././bprdwebsite/static/img/aboutus.PNG)
